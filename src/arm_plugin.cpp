...
namespace gazebo
{
    class arm_plugin : public ModelPlugin
    {
        ...
        private: rclcpp::Publisher<std_msgs::msg::Float32MultiArray>::SharedPtr pub_armjointpos;
        private: rclcpp::Publisher<std_msgs::msg::Float32MultiArray>::SharedPtr pub_armjointvel;
        ...
        public: void Load(physics::ModelPtr _model, sdf::ElementPtr )// _sdf)
        {
            ...
            // Initialize node
            node = rclcpp::Node::make_shared("my_arm_node");

            // Print messages
            RCLCPP_INFO(this->node->get_logger(), "arm_plugin run");
            std::cerr << "The arm plugin is attached to the model ["
                      << this->model->GetName() << "]\n";
            ...
            this->joint2_ = this->model->GetJoint("joint2");
            this->joint3_ = this->model->GetJoint("joint3");
            ...
            this->sub_torque = this->node->create_subscription<std_msgs::msg::Float32MultiArray>(
                ...
                qos,
                std::bind(&arm_plugin::ROSCallbackTorque_sim, this, std::placeholders::_1));

            // Create publisher
            this->pub_armjointpos = this->node->create_publisher<std_msgs::msg::Float32MultiArray>(
                robot_namespace+"ArmJointPos_sim", qos);
            this->pub_armjointvel = this->node->create_publisher<std_msgs::msg::Float32MultiArray>(
                robot_namespace+"ArmJointVel_sim", qos);
                       
            // Listen to the update event. This event is broadcast every
            // simulation iteration.
            this->updateConnection = gazebo::event::Events::ConnectWorldUpdateBegin(
                std::bind(&arm_plugin::OnUpdate, this));
        }
        ...
        public: void OnUpdate()
        {
            ...
            pub_armjointpos->publish(JointPos);
            ...
            pub_armjointvel->publish(JointVel);
